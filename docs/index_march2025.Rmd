...
$log(R_{t,r}/S_{t,r}) = \alpha_{t,r}*(1 - \frac{S_{t,r}}{Smax_r})  + \rho \epsilon_{t-1,r}$
...
$alpha_{t,r} = \alpha_{r} + \beta_{forestry,r}Forestry_{t,r}+ \beta_{npgo,r}NPGO_{t} + \beta_{sst,r}SST_{t,r} $

### Forestry effect on productivity

$\alpha_{t,r}  = \alpha_{r}  + \beta_{forestry,r}Forestry_{t,r}$



```{r fig.width=10, fig.height=6}

ric_chm_eca_alpha=read.csv(here('stan models','outs','posterior','ric_chm_eca_static_alpha.csv'),check.names=F)
ric_chm_cpd_alpha=read.csv(here('stan models','outs','posterior','ric_chm_cpd_static_alpha.csv'),check.names=F)

ric_chm_eca_npgo_sst_alpha=read.csv(here('stan models','outs','posterior','ric_chm_eca_npgo_sst_alpha.csv'),check.names=F)

ric_chm_cpd_npgo_sst_alpha=read.csv(here('stan models','outs','posterior','ric_chm_cpd_npgo_sst_alpha.csv'),check.names=F)

((plot_forestry_effect(posterior = ric_chm_cpd_alpha, effect = "cpd", species = "chum", model = "Ricker model with CPD", xlim = c(-0.5,0.5)) +
    plot_forestry_effect(posterior = ric_chm_eca_alpha, effect = "eca", species = "chum", model = "Ricker model with ECA", xlim = c(-0.5,0.5)))/(plot_forestry_effect(posterior = ric_chm_cpd_npgo_sst_alpha, effect = "cpd", species = "chum", model = "Ricker model with CPD, NPGO, SST", xlim = c(-0.5,0.5)) +
    plot_forestry_effect(posterior = ric_chm_eca_npgo_sst_alpha, effect = "eca", species = "chum", model = "Ricker model with ECA, NPGO, SST", xlim = c(-0.5,0.5))) + plot_layout(guides = "collect"))



(plot_npgo_effect(posterior = ric_chm_cpd_npgo_sst_alpha, effect = "npgo", species = "chum", model = "Ricker model with CPD, NPGO, SST", xlim = c(-0.5,0.5)) +
  plot_npgo_effect(posterior = ric_chm_eca_npgo_sst_alpha, effect = "npgo", species = "chum", model = "Ricker model with ECA, NPGO, SST", xlim = c(-0.5,0.5)))/(plot_sst_effect(posterior = ric_chm_cpd_npgo_sst_alpha, effect = "sst", species = "chum", model = "Ricker model with CPD, NPGO, SST", xlim = c(-0.5,0.5)) + plot_sst_effect(posterior = ric_chm_eca_npgo_sst_alpha, effect = "sst", species = "chum", model = "Ricker model with ECA, NPGO, SST", xlim = c(-0.5,0.5))) + plot_layout(guides = "collect")
...
bh_chm_eca_npgo_sst_alpha=read.csv(here('stan models','outs','posterior','bh_chm_eca_npgo_sst_alpha.csv'),check.names=F)

bh_chm_cpd_npgo_sst_alpha=read.csv(here('stan models','outs','posterior','bh_chm_cpd_npgo_sst_alpha.csv'),check.names=F)



(plot_npgo_effect(posterior = bh_chm_cpd_npgo_sst_alpha, effect = "npgo", species = "chum", model = "BH model with CPD, NPGO, SST", xlim = c(-3,3)) + plot_npgo_effect(posterior = bh_chm_cpd_ersst_correct, effect = "npgo", species = "chum", model = "BH model with ECA, NPGO, SST", xlim = c(-3,3)))/(plot_sst_effect(posterior = bh_chm_cpd_npgo_sst_alpha, effect = "sst", species = "chum", model = "BH model with CPD, NPGO, SST", xlim = c(-3,3)) + plot_sst_effect(posterior = bh_chm_cpd_ersst_correct, effect = "sst", species = "chum", model = "BH model with ECA, NPGO, SST", xlim = c(-3,3))) + plot_layout(guides = "collect")
...
cor_plot_3 <- cor_plot(posterior = bh_chm_cpd_ersst, effect = "cpd", model = "BH model with CPD, NPGO, SST", color_by_cu = TRUE)
...
ggsave(here('figures','correlation_forestry_effects_bh.png'),
       plot = cor_plot_3+
         theme(legend.position = "right",
          # legend.title = element_blank(),
          legend.key.size = unit(0.5, "cm"),
    ...
    guides(color = guide_legend(override.aes = list(alpha = 0.8, size = 4), ncol = 1)),
...
#has one divergent chain - need to run again
...
ric_chm_cpd_ersst_cc = read.csv(here('stan models','outs','posterior','ric_chm_cpd_npgo_ersst_cc.csv'),check.names=F)

((plot_forestry_effect(posterior = ric_chm_cpd_st_cc, effect = "cpd", species = "chum", model = "Ricker model with CPD", xlim = c(-3,3)) +
    plot_forestry_effect(posterior = ric_chm_eca_st_cc, effect = "eca", species = "chum", model = "Ricker model with ECA", xlim = c(-3,3)))/(plot_forestry_effect(posterior = ric_chm_cpd_ersst_cc, effect = "cpd", species = "chum", model = "Ricker model with CPD, NPGO, SST", xlim = c(-3,3)) +
...
ric_chm_eca_npgo_sst_K = read.csv(here('stan models','outs','posterior','ric_chm_eca_npgo_sst_K.csv'), check.names=F)
#divergent chains and high rhat

ric_chm_cpd_npgo_sst_K = read.csv(here('stan models','outs','posterior','ric_chm_cpd_npgo_sst_K.csv'), check.names=F)

(plot_forestry_effect(posterior = ric_chm_cpd_npgo_sst_K, effect = "cpd", species = "chum", model = "Ricker model with CPD, NPGO, SST", xlim = c(-2,2)) +
    plot_forestry_effect(posterior = ric_chm_eca_npgo_sst_K, effect = "eca", species = "chum", model = "Ricker model with ECA, NPGO, SST", xlim = c(-2,2)))/(plot_npgo_effect(posterior = ric_chm_cpd_npgo_sst_K, effect = "npgo", species = "chum", model = "Ricker model with CPD, NPGO, SST", xlim = c(-0.5,0.5)) + plot_sst_effect(posterior = ric_chm_cpd_npgo_sst_K, effect = "sst", species = "chum", model = "Ricker model with CPD, NPGO, SST", xlim = c(-0.5,0.5))) + plot_layout(guides = "collect")
...
$log(R_{t,r}/S_{t,r}) = \alpha_r + \alpha_t - log(1+\frac{(e^{\alpha_r + \alpha_t} - 1)}{K_{t,r}}  S_{t,r})  + \rho\epsilon_{t-1,r}$

Model with ocean covariates, forestry:

$log(R_{t,r}/S_{t,r}) = \alpha_r - log(1+\frac{(e^{\alpha_r  + \beta_{npgo,r}NPGO_{t} + \beta_{sst,r}SST_{t,r} } - 1)}{K_{t,r}}  S_{t,r})  + \beta_{npgo,r}NPGO_{t} + \beta_{sst,r}SST_{t,r} + \rho\epsilon_{t-1,r}$

Model with time varying coast-wide productivity, forestry, without autocorrelation:

$log(R_{t,r}/S_{t,r}) = \alpha_r + \alpha_t - log(1+\frac{(e^{\alpha_r + \alpha_t} - 1)}{K_{t,r}}  S_{t,r})  \epsilon_{t,r}$
...
bh_chm_eca_st_K = read.csv(here('stan models','outs','posterior','bh_chm_eca_static_K.csv'),check.names=F)
bh_chm_cpd_st_K = read.csv(here('stan models','outs','posterior','bh_chm_cpd_static_K.csv'),check.names=F)

bh_chm_eca_npgo_sst_K = read.csv(here('stan models','outs','posterior','bh_chm_eca_npgo_sst_K.csv'),check.names=F)

bh_chm_cpd_npgo_sst_K = read.csv(here('stan models','outs','posterior','bh_chm_cpd_npgo_sst_K.csv'),check.names=F)

(plot_forestry_effect(posterior = bh_chm_cpd_st_K, effect = "cpd", species = "chum", model = "BH model with CPD", xlim = c(-2,2)) +
    plot_forestry_effect(posterior = bh_chm_eca_st_K, effect = "eca", species = "chum", model = "BH model with ECA", xlim = c(-2,2)))/(plot_forestry_effect(posterior = bh_chm_cpd_npgo_sst_K, effect = "cpd", species = "chum", model = "BH model with CPD, NPGO, SST", xlim = c(-2,2)) + plot_forestry_effect(posterior = bh_chm_eca_npgo_sst_K, effect = "eca", species = "chum", model = "BH model with ECA, NPGO, SST", xlim = c(-2,2))) + plot_layout(guides = "collect")
...
# Models with forestry effects of Maximum Recruitment

## Beverton-Holt (BH):

Model with static productivity, forestry:

$log(R_{t,r}/S_{t,r}) = \alpha_r - log(1+\frac{(e^{\alpha_r})}{Rk_{t,r}}  S_{t,r}) + \rho\epsilon_{t-1,r}$

Model with time varying coastwide productivity, forestry:

$log(R_{t,r}/S_{t,r}) = \alpha_r + \alpha_t - log(1+\frac{(e^{\alpha_r + \alpha_t} )}{Rk_{t,r}}  S_{t,r})  + \rho\epsilon_{t-1,r}$

Model with ocean covariates, forestry:

$log(R_{t,r}/S_{t,r}) = \alpha_r - log(1+\frac{(e^{\alpha_r  + \beta_{npgo,r}NPGO_{t} + \beta_{sst,r}SST_{t,r} } )}{Rk_{t,r}}  S_{t,r})  + \beta_{npgo,r}NPGO_{t} + \beta_{sst,r}SST_{t,r} + \rho\epsilon_{t-1,r}$

Model with time varying coast-wide productivity, forestry, without autocorrelation:

$log(R_{t,r}/S_{t,r}) = \alpha_r + \alpha_t - log(1+\frac{(e^{\alpha_r + \alpha_t})}{Rk_{t,r}}  S_{t,r})  \epsilon_{t,r}$

### Forestry effect  on carrying capacity

$log(Rk_{t,r}) = log(Rk_r) + \beta_{forestry,r}Forestry_{t,r}$

$Rk_{t,r} = Rk_r e^{\beta_{forestry,r}Forestry_{t,r}}$
...
bh_chm_eca_ersst_cc = read.csv(here('stan models','outs','posterior','bh_chm_eca_npgo_ersst_cc_2.csv'),check.names=F)
bh_chm_cpd_ersst_cc = read.csv(here('stan models','outs','posterior','bh_chm_cpd_npgo_ersst_cc_2.csv'),check.names=F)

# _2 because initially I didnt have npgo and SST only effecting productivity, but now I do 

bh_chm_eca_ersst_cc_subset = read.csv(here('stan models','outs','posterior','bh_chm_eca_npgo_ersst_cc_subset.csv'),check.names=F)
bh_chm_cpd_ersst_cc_subset = read.csv(here('stan models','outs','posterior','bh_chm_cpd_npgo_ersst_cc_subset.csv'),check.names=F)
...
(plot_forestry_effect(posterior = bh_chm_cpd_ersst_cc_subset, effect = "cpd", species = "chum", model = "BH model with CPD, NPGO, SST", xlim = c(-2,2)) +
    plot_forestry_effect(posterior = bh_chm_eca_ersst_cc_subset, effect = "eca", species = "chum", model = "BH model with ECA, NPGO, SST", xlim = c(-2,2)))/(plot_forestry_effect(posterior = bh_chm_cpd_ersst_cc, effect = "cpd", species = "chum", model = "BH model with CPD, NPGO, SST", xlim = c(-2,2)) +
    plot_forestry_effect(posterior = bh_chm_eca_ersst_cc, effect = "eca", species = "chum", model = "BH model with ECA, NPGO, SST", xlim = c(-2,2))) + plot_layout(guides = "collect")
...
plot_capacity_decline <- function(posterior = bh_chm_cpd_ersst_correct, effect = "cpd", species = "chum", model = "BH model with NPGO, SST"){
  ...
  global_df <- data.frame(forestry = forestry,
                          capacity_median = global_prediction,
                          q025 = global_025,
                          q975 = global_975)
  ...
  for (i in 1:length(unique(df$River_n))){
    ...
    capacity <- (exp(as.matrix(b_rv[,1])%*%
                           (forestry_sqrt_std-no_forestry)))*100 - 100
    
    capacity_median <- apply(capacity,2,median)
    
    capacity_median_df <- data.frame(River = unique(river_data$River),
                                         capacity_median = capacity_median,
                                         forestry = forestry_river) %>% 
  filter(forestry >= min(forestry_river), forestry <= max(forestry_river))
    
    full_capacity <- rbind(full_capacity, capacity_median_df)
  ...
  median_df <- data.frame(forestry = forestry,
                          capacity_median = median_prediction)
  
  if(effect == "eca" || effect == "cpd"){
    p1 <- ggplot(full_capacity) +
    geom_line(aes(x = forestry, y = capacity_median, group = River,
                  color = "watershed level\nforestry effect"),alpha=0.5) +
    geom_line(data = global_df, 
              aes(x = forestry, y = capacity_median, color = "global forestry effect"), linewidth = 1) +
    geom_ribbon(data = global_df, aes(x = forestry, ymin = q025, ymax = q975),
                alpha = 0.5, fill = "gray") +
    # scale_fill_manual("",values  = c("95% credible interval" = "gray")) +
    scale_color_manual("",values = c("watershed level\nforestry effect" = "darkgray", 
    ...
    geom_line(aes(x = forestry, y = capacity_median, group = River,
                  color = "watershed level\nSST effect"),alpha=0.5) +
    geom_line(data = global_df, 
              aes(x = forestry, y = capacity_median, color = "global SST effect"), linewidth = 1) +
    geom_ribbon(data = global_df, aes(x = forestry, ymin = q025, ymax = q975),
                alpha = 0.5, fill = "gray") +
    # scale_fill_manual("",values  = c("95% credible interval" = "gray")) +
    scale_color_manual("",values = c("watershed level\nSST effect" = "darkgray", 
...
(plot_capacity_decline(posterior = ric_chm_cpd_ersst_cc2, effect = "cpd", species = "chum", model = "Ricker model with CPD, NPGO, SST") + plot_capacity_decline(posterior = ric_chm_eca_ersst_cc2, effect = "eca", species = "chum", model = "Ricker model with ECA, NPGO, SST"))/(plot_capacity_decline(posterior = bh_chm_cpd_ersst_cc, effect = "cpd", species = "chum", model = "BH model with CPD, NPGO, SST") + plot_capacity_decline(posterior = bh_chm_eca_ersst_cc, effect = "eca", species = "chum", model = "BH model with ECA, NPGO, SST")) + plot_layout(guides = "collect")
...
```{r fig.width=10, fig.height=8}
plot_recruit_spawner <- function(data, species = "chum", river, river_data,  posterior, posterior_bh, posterior_cc, posterior_bh_cc){
  ...
  if(species == "chum"){
    ...
    posterior_cc_rv_b_for <- posterior_cc %>% 
      select(starts_with('b_for_rv')) %>%
      select(ends_with(paste0("[",river,"]")))
    
    posterior_cc_rv_alpha_j <- posterior_cc %>%
      select(starts_with('alpha_j')) %>%
      select(ends_with(paste0("[",river,"]")))
    
    posterior_cc_rv_k <- posterior_cc %>%
    ...
    posterior_bh_cc_rv_b_for <- posterior_bh_cc %>%
      select(starts_with('b_for_rv')) %>%
      select(ends_with(paste0("[",river,"]")))
    
    posterior_bh_cc_rv_alpha_j <- posterior_bh_cc %>%
      select(starts_with('alpha_j')) %>%
      select(ends_with(paste0("[",river,"]")))
    
    posterior_bh_cc_rv_Rk <- posterior_bh_cc %>%
      select(starts_with('Rk')) %>%
      select(ends_with(paste0("[",river,"]")))
    ...
    posterior_bh_cc_rv_Rk_for <- posterior_bh_cc_rv_Rk*exp(posterior_bh_cc_rv_b_for[,1]*mid_cpd)
    
    recruits_bh_cc_predicted <- (matrix(posterior_bh_cc_rv_alpha_j[,1], ncol = length(spawners_predicted), nrow = length(posterior_bh_cc_rv_alpha_j[,1])) - log(1+as.matrix(exp(posterior_bh_cc_rv_alpha_j[,1] + matrix(posterior_bh_cc_rv_b_for[,1]*mid_cpd, ncol = length(spawners_predicted), nrow = length(posterior_bh_cc_rv_alpha_j[,1])))/posterior_bh_cc_rv_Rk)%*%spawners_predicted) + matrix(posterior_bh_cc_rv_b_for[,1]*mid_cpd, ncol = length(spawners_predicted), nrow = length(posterior_bh_cc_rv_alpha_j[,1])))          
...
if(species == "chum"){
    ...
    posterior_cc <- ric_chm_cpd_ersst_cc2
    
    posterior_bh_cc <- bh_chm_cpd_ersst_cc
...
plot_recruit_spawner(df, species = "chum", river, river_data, posterior = ric_chm_cpd_ersst, posterior_bh = bh_chm_cpd_ersst_correct, posterior_cc, posterior_bh_cc)
...
(plot_forestry_effect(posterior = ric_pk_cpd_st, effect = "cpd", species = "pink", model = "Ricker model with CPD", xlim = c(-0.5,0.5)) +
    plot_forestry_effect(posterior = ric_pk_eca_st, effect = "eca", species = "pink", model = "Ricker model with ECA", xlim = c(-0.5,0.5)))/(plot_forestry_effect(posterior = ric_pk_cpd, effect = "cpd", species = "pink", model = "Ricker model with CPD,\ncoastwide productivity", xlim = c(-0.5,0.5)) +
    plot_forestry_effect(posterior = ric_pk_eca, effect = "eca", species = "pink", model = "Ricker model with ECA,\ncoastwide productivity", xlim = c(-0.5,0.5)))/(plot_forestry_effect(posterior = ric_pk_cpd_ersst, effect = "cpd", species = "pink", model = "Ricker model with CPD, NPGO, SST", xlim = c(-0.5,0.5)) +
    plot_forestry_effect(posterior = ric_pk_eca_ersst, effect = "eca", species = "pink", model = "Ricker model with ECA, NPGO, SST", xlim = c(-0.5,0.5)))+ plot_layout(guides = "collect")
...
(plot_forestry_effect(posterior = bh_pk_cpd_st_correct, effect = "cpd", species = "pink", model = "BH model with CPD", xlim = c(-0.5,0.5)) + plot_forestry_effect(posterior = bh_pk_eca_st_correct, effect = "eca", species = "pink", model = "BH model with ECA", xlim = c(-0.5,0.5)))/(plot_forestry_effect(posterior = bh_pk_cpd_correct, effect = "cpd", species = "pink", model = "BH model with CPD,\ncoastwide productivity", xlim = c(-0.5,0.5)) + plot_forestry_effect(posterior = bh_pk_eca_correct, effect = "eca", species = "pink", model = "BH model with ECA,\ncoastwide productivity", xlim = c(-0.5,0.5)))/(plot_forestry_effect(posterior = bh_pk_cpd_ersst_correct, effect = "cpd", species = "pink", model = "BH model with NPGO, ERSST", xlim = c(-0.5,0.5)) + plot_forestry_effect(posterior = bh_pk_eca_ersst_correct, effect = "eca", species = "pink", model = "BH model with NPGO, ERSST", xlim = c(-0.5,0.5))) + plot_layout(guides = "collect")
...
# ric_pk_eca_ersst_cc = read.csv(here('stan models','outs','posterior','ric_pk_eca_st_noac_npgo_ersst_cc.csv'),check.names=F)
# ric_pk_cpd_ersst_cc = read.csv(here('stan models','outs','posterior','ric_pk_cpd_st_noac_npgo_ersst_cc.csv'),check.names=F)
# 
# ((plot_forestry_effect(posterior = ric_pk_cpd_ersst_cc, effect = "cpd", species = "pink", model = "Ricker model with CPD, NPGO, SST", xlim = c(-3,3)) +
#     plot_forestry_effect(posterior = ric_pk_eca_ersst_cc, effect = "eca", species = "pink", model = "Ricker model with ECA, NPGO, SST", xlim = c(-3,3))) + plot_layout(guides = "collect"))
...
bh_pk_cpd_ersst_cc = read.csv(here('stan models','outs','posterior','bh_pk_cpd_noac_w_npgo_ersst_cc.csv'),check.names=F)

bh_pk_eca_ersst_cc = read.csv(here('stan models','outs','posterior','bh_pk_eca_noac_w_npgo_ersst_cc.csv'),check.names=F)

((plot_forestry_effect(posterior = bh_pk_cpd_ersst_cc, effect = "cpd", species = "pink", model = "BH model with CPD, NPGO, SST", xlim = c(-1,1)) +
    plot_forestry_effect(posterior = bh_pk_eca_ersst_cc, effect = "eca", species = "pink", model = "BH model with ECA, NPGO, SST", xlim = c(-1,1))) + plot_layout(guides = "collect"))
