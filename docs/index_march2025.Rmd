...
(plot_forestry_effect(posterior = ric_chm_cpd_npgo_sst_K, effect = "cpd", species = "chum", model = "Ricker model with CPD, NPGO, SST", xlim = c(-3,3)) +
    plot_forestry_effect(posterior = ric_chm_eca_npgo_sst_K, effect = "eca", species = "chum", model = "Ricker model with ECA, NPGO, SST", xlim = c(-3,3))) + plot_layout(guides = "collect")
