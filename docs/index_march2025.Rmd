...
((plot_forestry_effect(posterior = bh_chm_cpd_st_cc, effect = "cpd", species = "chum", model = "BH model with CPD", xlim = c(-3,3)) +
    ...
    plot_forestry_effect(posterior = bh_chm_eca_ersst_cc, effect = "eca", species = "chum", model = "BH model with ECA, NPGO, SST", xlim = c(-3,3)))/(plot_forestry_effect(posterior = bh_chm_cpd_noac_cc, effect = "cpd", species = "chum", model = "BH model with CPD, NPGO, SST,\n without autocorrelation", xlim = c(-3,3)) + plot_forestry_effect(posterior = bh_chm_eca_noac_cc, effect = "eca", species = "chum", model = "BH model with ECA, NPGO, SST,\n without autocorrelation", xlim = c(-3,3))) + plot_layout(guides = "collect"))
