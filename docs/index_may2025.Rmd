...
((plot_forestry_effect(posterior = ric_chm_cpd_st, effect = "cpd", species = "chum", model = "Ricker model with CPD", xlim = c(-0.5,0.5)) +
    ...
    plot_forestry_effect(posterior = ric_chm_eca_ocean_covariates, effect = "eca", species = "chum", model = "Ricker model with ECA, NPGO, SST", xlim = c(-0.5,0.5))) + plot_layout(guides = "collect"))
