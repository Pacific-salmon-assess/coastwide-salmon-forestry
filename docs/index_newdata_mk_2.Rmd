...
plot_npgo_effect <- function(posterior = bh_chm_eca_npgo, effect = "npgo", species = "chum", model = "BH model with NPGO") {
...
(plot_npgo_effect(posterior = bh_chm_eca_npgo, effect = "eca", species = "chum", model = "BH model with NPGO") +
  ...
  plot_npgo_effect(posterior = bh_chm_cpd_lh_sst, effect = "cpd", species = "chum", model = "BH model with NPGO, LH SST"))
...
plot_sst_effect <- function(posterior = bh_chm_eca_sst, effect = "sst", species = "chum", model = "BH model with NPGO") {
  ...
  posterior_rv <- posterior %>% 
    ...
    mutate(River_n = as.numeric(str_extract(River, '\\d+'))) %>% 
    select(-River) %>%
    left_join(ch20rsc %>% select(River_n, CU, CU_name), by = 'River_n')
...
(plot_sst_effect(posterior = bh_chm_eca_sst, effect = "eca", species = "chum", model = "BH model with NPGO, SST") +
  plot_sst_effect(posterior = bh_chm_cpd_sst, effect = "cpd", species = "chum", model = "BH model with NPGO, SST"))/(plot_sst_effect(posterior = bh_chm_eca_lh_sst, effect = "eca", species = "chum", model = "BH model with NPGO, LH SST") +
  plot_sst_effect(posterior = bh_chm_cpd_lh_sst, effect = "cpd", species = "chum", model = "BH model with NPGO, LH SST"))

bh_chm_cpd_lh_sst_rv <- bh_chm_cpd_lh_sst %>% 
  select(starts_with('b_sst_rv')) %>%
  pivot_longer(cols = everything(), 
               names_to = 'River', 
               names_prefix = 'b_sst_rv',
...
ggplot() +
  stat_density(data= bh_chm_cpd_lh_sst_rv, aes(sst_effect, color = CU_name, group = River_n),
               geom = 'line', position = 'identity',
  ...
  scale_color_iwanthue(name = 'CU', hmin = 0, hmax = 360, cmin = 0, cmax = 80,
                       lmin = 10, lmax = 95) +
  geom_density(aes(bh_chm_cpd_lh_sst$b_sst), color = 'black', linewidth = 1.2, alpha = 0.2)+
  theme_classic()+
...
ggplot() +
  stat_density(data= bh_chm_cpd_lh_sst_rv, aes(sst_effect, color = Y_LAT, group = River_n),
               geom = 'line', position = 'identity',
               alpha = 0.05, linewidth = 1) +
  geom_vline(xintercept = 0, color = 'slategray', linewidth = 0.8) +
  labs(title = 'BH model with NPGO, SST, CPD',
  ...
  # scale_color_iwanthue(name = 'CU', hmin = 0, hmax = 360, cmin = 0, cmax = 80,
  #                      lmin = 10, lmax = 95) +
  scale_color_viridis_c(name = 'Latitude', direction = -1)+
  geom_density(aes(bh_chm_cpd_lh_sst$b_sst), color = 'black', linewidth = 1.5, alpha = 0.1)+
  theme_classic()+
  theme(legend.position = "right",
        axis.title.x = element_text(size = 14),
        axis.title.y = element_text(size = 14),
...
(plot_forestry_effect(posterior = ric_chm_eca, effect = "eca", species = "chum", model = "Ricker model with coastwide productivity", xlim = c(-0.5,0.5)) +
    ...
    plot_forestry_effect(posterior = ric_chm_cpd_npgo, effect = "cpd", species = "chum", model = "Ricker model with NPGO", xlim = c(-0.5,0.5)))/(
      plot_forestry_effect(posterior = ric_chm_eca_sst, effect = "eca", species = "chum", model = "Ricker model with NPGO, LH SST", xlim = c(-0.5,0.5)) +
    plot_forestry_effect(posterior = ric_chm_cpd_sst, effect = "cpd", species = "chum", model = "Ricker model with NPGO, LH SST", xlim = c(-0.5,0.5)))
...
(plot_productivity_decline(posterior = ric_chm_eca, effect = "eca", species = "chum", model = "Ricker model with coastwide productivity") +
  ...
  plot_productivity_decline(posterior = ric_chm_cpd_npgo, effect = "cpd", species = "chum", model = "Ricker model with NPGO"))/(plot_productivity_decline(posterior = ric_chm_eca_sst, effect = "eca", species = "chum", model = "Ricker model with NPGO, LH SST") +
  plot_productivity_decline(posterior = ric_chm_cpd_sst, effect = "cpd", species = "chum", model = "Ricker model with NPGO, LH SST"))
...
(plot_npgo_effect(posterior = ric_chm_eca_npgo, effect = "eca", species = "chum", model = "Ricker model with NPGO") +
  plot_npgo_effect(posterior = ric_chm_cpd_npgo, effect = "cpd", species = "chum", model = "Ricker model with NPGO"))/(plot_npgo_effect(posterior = ric_chm_eca_sst, effect = "eca", species = "chum", model = "Ricker model with NPGO, LH SST") +
  plot_npgo_effect(posterior = ric_chm_cpd_sst, effect = "cpd", species = "chum", model = "Ricker model with NPGO, LH SST"))
...
(plot_sst_effect(posterior = ric_chm_eca_sst, effect = "eca", species = "chum", model = "Ricker model with NPGO, LH SST") +
  plot_sst_effect(posterior = ric_chm_cpd_sst, effect = "cpd", species = "chum", model = "Ricker model with NPGO, LH SST"))
...
(plot_npgo_effect(posterior = bh_pk_eca_npgo, effect = "npgo", species = "pink", model = "BH model with NPGO") +
  ...
  plot_npgo_effect(posterior = bh_pk_cpd_sst, effect = "npgo", species = "pink", model = "BH model with NPGO, LH SST"))
...
(plot_sst_effect(posterior = bh_pk_eca_sst, effect = "sst", species = "pink", model = "BH model with NPGO, LH SST") +
  plot_sst_effect(posterior = bh_pk_cpd_sst, effect = "sst", species = "pink", model = "BH model with NPGO, LH SST"))
...
(plot_npgo_effect(posterior = ric_pk_eca_npgo, effect = "npgo", species = "pink", model = "Ricker model with NPGO") +
  ...
  plot_npgo_effect(posterior = ric_pk_cpd_sst, effect = "npgo", species = "pink", model = "Ricker model with NPGO, LH SST"))
...
(plot_sst_effect(posterior = ric_pk_eca_sst, effect = "sst", species = "pink", model = "Ricker model with NPGO, LH SST") +
  plot_sst_effect(posterior = ric_pk_cpd_sst, effect = "sst", species = "pink", model = "Ricker model with NPGO, LH SST"))
