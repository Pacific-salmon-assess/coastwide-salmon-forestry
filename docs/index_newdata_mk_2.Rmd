...
plot_sst_effect <- function(posterior = bh_chm_eca_sst, effect = "sst", species = "chum", model = "BH model with NPGO", 
  ...
  posterior_rv <- posterior %>% 
    ...
    mutate(River_n = as.numeric(str_extract(River, '\\d+'))) %>% 
    select(-River) %>%
  left_join(df %>% select(River_n, CU, CU_name, X_LONG, Y_LAT), by = 'River_n')
...
((plot_sst_effect(posterior = bh_chm_eca_sst, effect = "eca", species = "chum", model = "BH model with NPGO, SST", xlim = c(-0.5,0.5)) +
  ...
  plot_sst_effect(posterior = bh_chm_cpd_lh_sst, effect = "cpd", species = "chum", model = "BH model with NPGO, LH SST", xlim = c(-0.5,0.5)))+ plot_layout(guides = "collect"))
...
((plot_sst_effect(posterior = bh_chm_eca_sst, effect = "eca", species = "chum", model = "BH model with NPGO, SST", color_by = "Y_LAT", xlim = c(-0.5,0.5)) +
  ...
  plot_sst_effect(posterior = bh_chm_cpd_lh_sst, effect = "cpd", species = "chum", model = "BH model with NPGO, LH SST", color_by = "Y_LAT", xlim = c(-0.5,0.5)))+ plot_layout(guides = "collect"))
...
((plot_sst_effect(posterior = ric_chm_eca_sst, effect = "eca", species = "chum", model = "Ricker model with NPGO, SST") +
  plot_sst_effect(posterior = ric_chm_cpd_sst, effect = "cpd", species = "chum", model = "Ricker model with NPGO, SST"))/(
  plot_sst_effect(posterior = ric_chm_eca_lh_sst, effect = "eca", species = "chum", model = "Ricker model with NPGO, LH SST") +
  plot_sst_effect(posterior = ric_chm_cpd_lh_sst, effect = "cpd", species = "chum", model = "Ricker model with NPGO, LH SST")) + plot_layout(guides = "collect")
  )
...
((plot_sst_effect(posterior = bh_pk_eca_sst, effect = "sst", species = "pink", model = "BH model with NPGO, LH SST") +
  plot_sst_effect(posterior = bh_pk_cpd_sst, effect = "sst", species = "pink", model = "BH model with NPGO, LH SST"))+ plot_layout(guides = "collect"))
...
((plot_sst_effect(posterior = ric_pk_eca_sst, effect = "sst", species = "pink", model = "Ricker model with NPGO, LH SST", color_by = "CU") +
  plot_sst_effect(posterior = ric_pk_cpd_sst, effect = "sst", species = "pink", model = "Ricker model with NPGO, LH SST", color_by = "CU")) + plot_layout(guides = "collect"))
