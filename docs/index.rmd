...
d_pk_eca=read.csv(here('stan models','outs','fits','posterior','bh_pk_eca.csv'),check.names=F)
d_pk_cpd=read.csv(here('stan models','outs','fits','posterior','bh_pk_cpd.csv'),check.names=F)
...
plot(m_pred_chm_eca*100-100~chm_eca_n,bty='l',type='n',ylab='Change in productivity (R/S, %)',xlab='',ylim=c(-90,90),col='darkred',lwd=3,yaxt='n',xlim=c(min(chm_eca_n*100),max(chm_eca_n*100)))
...
plot(m_pred_pk_eca*100-100~pk_eca_n,bty='l',type='n',ylab='Change in productivity (R/S, %)',xlab='Equivalent Clearcut Area (% of watershed)',ylim=c(-90,90),col='darkred',lwd=3,yaxt='n',xlim=c(min(pk_eca_n*100),max(pk_eca_n*100)))
axis(side=2,at=seq(-90,90,by=15))
abline(h=0,lwd=0.5,lty=5)
...
plot(m_pred_pk_cpd*100-100~pk_cpd_n,bty='l',type='n',ylab='',xlab='Cumulative Disturbed Area (% of watershed)',ylim=c(-90,90),col='darkred',lwd=3,yaxt='n',xlim=c(min(pk_cpd_n),max(pk_cpd_n)))
axis(side=2,at=seq(-90,90,by=15))
abline(h=0,lwd=0.5,lty=5)
