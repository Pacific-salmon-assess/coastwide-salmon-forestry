...
# Comparison of foresty effects across density-dependent forms and with/without coastwide time-varying productivity

Chum - equivalent clearcut area:
```{r,dd_tv comp, chm eca}
bh_chm_eca_tv=read.csv(here('stan models','outs','posterior','bh_chm_eca_ac.csv'),check.names=F)
bh_chm_eca_st=read.csv(here('stan models','outs','posterior','bh_chm_eca_st.csv'),check.names=F)

ric_chm_eca_tv=read.csv(here('stan models','outs','posterior','bh_chm_eca_ac.csv'),check.names=F)
ric_chm_eca_st=read.csv(here('stan models','outs','posterior','bh_chm_eca_st.csv'),check.names=F)

cush_chm_eca_tv=read.csv(here('stan models','outs','posterior','bh_chm_eca_ac.csv'),check.names=F)
cush_chm_eca_st=read.csv(here('stan models','outs','posterior','bh_chm_eca_st.csv'),check.names=F)

par(mfrow=c(3,2))

plot(c(0,10)~c(-1.5,1.5),bty='l',type='n',ylab='Posterior density',main='ECA effect (BH, time-varying)',ylim=c(0,10),yaxt='n',xlab='Standardized coefficients')
d0cpd=density(bh_chm_eca_tv[,2],bw=0.02)
for(j in 3:24){
  d=density(bh_chm_eca_tv[,j],bw=0.02)
  lines(d$y~d$x,col=adjustcolor('darkgray',alpha.f=0.6))
}
lines(d0cpd$y~d0cpd$x,col='darkred',lwd=3)
abline(v=0,lwd=2)

plot(c(0,10)~c(-1.5,1.5),bty='l',type='n',ylab='Posterior density',main='ECA effect (BH, static)',ylim=c(0,10),yaxt='n',xlab='Standardized coefficients')
d0cpd=density(bh_chm_eca_st[,2],bw=0.02)
for(j in 3:24){
  d=density(bh_chm_eca_st[,j],bw=0.02)
  lines(d$y~d$x,col=adjustcolor('darkgray',alpha.f=0.6))
}
lines(d0cpd$y~d0cpd$x,col='darkred',lwd=3)
abline(v=0,lwd=2)

plot(c(0,10)~c(-1.5,1.5),bty='l',type='n',ylab='Posterior density',main='ECA effect (Ricker, time-varying)',ylim=c(0,10),yaxt='n',xlab='Standardized coefficients')
d0cpd=density(bh_chm_eca_tv[,2],bw=0.02)
for(j in 3:24){
  d=density(bh_chm_eca_tv[,j],bw=0.02)
  lines(d$y~d$x,col=adjustcolor('darkgray',alpha.f=0.6))
...
plot(c(0,10)~c(-1.5,1.5),bty='l',type='n',ylab='Posterior density',main='ECA effect (Ricker, static)',ylim=c(0,10),yaxt='n',xlab='Standardized coefficients')
d0cpd=density(bh_chm_eca_st[,2],bw=0.02)
for(j in 3:24){
  d=density(bh_chm_eca_st[,j],bw=0.02)
  lines(d$y~d$x,col=adjustcolor('darkgray',alpha.f=0.6))
...
plot(c(0,10)~c(-1.5,1.5),bty='l',type='n',ylab='Posterior density',main='ECA effect (Cushing, time-varying)',ylim=c(0,10),yaxt='n',xlab='Standardized coefficients')
d0cpd=density(cush_chm_eca_tv[,2],bw=0.02)
for(j in 3:24){
  d=density(bh_chm_eca_tv[,j],bw=0.02)
  lines(d$y~d$x,col=adjustcolor('darkgray',alpha.f=0.6))
}
...
plot(c(0,10)~c(-1.5,1.5),bty='l',type='n',ylab='Posterior density',main='ECA effect (Cushing, static)',ylim=c(0,10),yaxt='n',xlab='Standardized coefficients')
d0cpd=density(cush_chm_eca_st[,2],bw=0.02)
for(j in 3:24){
  d=density(bh_chm_eca_st[,j],bw=0.02)
  lines(d$y~d$x,col=adjustcolor('darkgray',alpha.f=0.6))
}
...
df=data.frame(scenario=c('BH','BH (static)','Ricker','Ricker (static)','Cushing','Cushing (static)'),median=NA,l95=NA,u95=NA,l80=NA,u80=NA)
df[1,2]=


```

Chum - cumulative % disturbed:

Pink - equivalent clearcut area:
```{r,dd_tv comp}
