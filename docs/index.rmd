...
plot(m_pred*100-100~eca_n,bty='l',type='n',ylab='Change in intrinsic productivity (recruits/spawner, %)',xlab='Equivalent clearcut area',ylim=c(-60,0),col='darkred',lwd=3,yaxt='n')
axis(side=2,at=seq(-60,0,by=10))
abline(h=100,lwd=0.5,lty=5)
for(c in 1:length(unique(ch20r$River))){
  jj=subset(ch20r,River==levels(factor(ch20r$River))[c])
