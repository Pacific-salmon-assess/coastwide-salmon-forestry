...
bh_chm_eca_ersst_correct=read.csv(here('stan models','outs','posterior','bh_chm_eca_static_corrected.csv'),check.names=F)
bh_chm_cpd_ersst_correct=read.csv(here('stan models','outs','posterior','bh_chm_cpd_static_corrected.csv'),check.names=F)

(plot_forestry_effect(posterior = bh_chm_eca_st_correct, effect = "eca", species = "chum", model = "BH model without coastwide productivity") +
    plot_forestry_effect(posterior = bh_chm_cpd_st_correct, effect = "cpd", species = "chum", model = "BH model without coastwide productivity"))
