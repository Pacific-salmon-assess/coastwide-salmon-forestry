...
bh_chm_eca_st_cc = read.csv(here('stan models','outs','posterior','bh_chm_eca_static_trial_cc.csv'),check.names=F)

bh_chm_cpd_st_cc = read.csv(here('stan models','outs','posterior','bh_chm_cpd_static_trial_cc.csv'),check.names=F)

((plot_forestry_effect(posterior = bh_chm_eca_st_cc, effect = "eca", species = "chum", model = "BH model with NPGO, ERSST, CC", xlim = c(-3,3)) + plot_forestry_effect(posterior = bh_chm_cpd_st_cc, effect = "cpd", species = "chum", model = "BH model with NPGO, ERSST, CC", xlim = c(-3,3)))/(plot_forestry_effect(posterior = bh_chm_eca_ersst, effect = "eca", species = "chum", model = "BH model with NPGO, ERSST", xlim = c(-3,3)) +
    plot_forestry_effect(posterior = bh_chm_cpd_ersst, effect = "cpd", species = "chum", model = "BH model with NPGO, ERSST", xlim = c(-3,3))) + plot_layout(guides = "collect"))
...
# 
# plot_recruit_spawner(river = 7, posterior = posterior, posterior_bh = posterior_bh, river_data = river_data)
