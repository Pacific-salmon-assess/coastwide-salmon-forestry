...
ggsave(here("figures","chum_forestry_effect_all_models.png"), width = 10, height = 8, dpi = 300)



(plot_forestry_effect(posterior = bh_chm_eca_ersst, effect = "eca", species = "chum", model = "BH model with NPGO, ERSST") +
    plot_forestry_effect(posterior = bh_chm_cpd_ersst, effect = "cpd", species = "chum", model = "BH model with NPGO, ERSST")) + plot_layout(guides = "collect")

# save

ggsave(here("figures","chum_forestry_effect_npgo_ersst.png"), width = 10, height = 4, dpi = 300)
...
plot_forestry_effect(posterior = ric_chm_eca_ersst, effect = "eca", species = "chum", model = "Ricker model with NPGO, ERSST", xlim = c(-0.5,0.5)) + plot_forestry_effect(posterior = ric_chm_cpd_ersst, effect = "cpd", species = "chum", model = "Ricker model with NPGO, ERSST", xlim = c(-0.5,0.5)) + plot_layout(guides = "collect")
