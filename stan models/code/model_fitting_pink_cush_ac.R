...
if(Sys.info()[7] == "mariakur") {
  ...
  post_cush_pk_eca=cush_pk_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j'),format='draws_matrix')
...
if(Sys.info()[7] == "mariakur") {
  ...
  post_cush_pk_cpd=cush_pk_cpd$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j'),format='draws_matrix')
