...
#file_csh=file.path(here('stan models', 'code', 'cush_pink_ac_mk.stan'))
#mcush_p=cmdstanr::cmdstan_model(file_csh) #compile stan code to C++
#
##even year pinks
#pk10r_e <- read.csv(here("origional-ecofish-data-models","Data",
#                         "Processed","pke_SR_10_hat_yr_reduced_VRI90.csv"))
#
##odd year pinks
#pk10r_o <- read.csv(here("origional-ecofish-data-models","Data",
#                         "Processed","PKO_SR_10_hat_yr_reduced_VRI90.csv"))
#
#options(mc.cores=8)
#
...
#if(Sys.info()[7] == "mariakur") {
#  print("Running on local machine")
#  cush_pk_eca <- mcush_p$sample(data=dl_pk_eca,
#                              chains = 1, 
#                              iter_warmup = 20,
#                              iter_sampling =50,
#                              refresh = 10,
#                              adapt_delta = 0.999,
#                              max_treedepth = 20)
#  write.csv(cush_pk_eca$summary(),'./stan models/outs/summary/cush_pk_eca_ac_trial.csv')
#  cush_pk_eca$save_object('./stan models/outs/fits/cush_pk_eca_ac_trial.RDS')
#  
#  post_cush_pk_eca=cush_pk_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','b','sigma'),format='draws_matrix')
#  write.csv(post_cush_pk_eca,here('stan models','outs','posterior','cush_pk_eca_ac_trial.csv'))
#  
#} else {
#  cush_pk_eca <- mcush_p$sample(data=dl_pk_eca,
#                              chains = 6, 
...
#                              max_treedepth = 20)
#  
#  write.csv(cush_pk_eca$summary(),here("stan models","outs","summary","cush_pk_eca_ac.csv"))
#  cush_pk_eca$save_object(here("stan models","outs","fits","cush_pk_eca_ac.RDS"))
#  
#  post_cush_pk_eca=cush_pk_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','b','sigma'),format='draws_matrix')
#  write.csv(post_cush_pk_eca,here('stan models','outs','posterior','cush_pk_eca_ac.csv'))
#  
#}
#
#print("cpd")
...
#if(Sys.info()[7] == "mariakur") {
#  print("Running on local machine")
#  cush_pk_cpd <- mcush_p$sample(data=dl_pk_cpd,
#                              chains = 1, 
#                              iter_warmup = 20,
#                              iter_sampling =50,
#                              refresh = 10,
#                              adapt_delta = 0.999,
#                              max_treedepth = 20)
#  write.csv(cush_pk_cpd$summary(),'./stan models/outs/summary/cush_pk_cpd_ac_trial.csv')
#  cush_pk_cpd$save_object('./stan models/outs/fits/cush_pk_cpd_ac_trial.RDS')
#  
#  post_cush_pk_cpd=cush_pk_cpd$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','b','sigma'),format='draws_matrix')
#  write.csv(post_cush_pk_cpd,here('stan models','outs','posterior','cush_pk_cpd_ac_trial.csv'))
#  
#} else {
#  cush_pk_cpd <- mcush_p$sample(data=dl_pk_cpd,
#                              chains = 6, 
...
#                              max_treedepth = 20)
#  
#  write.csv(cush_pk_cpd$summary(),here("stan models","outs","summary","cush_pk_cpd_ac.csv"))
#  cush_pk_cpd$save_object(here("stan models","outs","fits","cush_pk_cpd_ac.RDS"))
#  
#  post_cush_pk_cpd=cush_pk_cpd$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','b','sigma'),format='draws_matrix')
#  write.csv(post_cush_pk_cpd,here('stan models','outs','posterior','cush_pk_cpd_ac.csv'))
#  
#}

#reading model outputs and saving posterior 
print("saving posterior file")
cush_pk_eca = readRDS(here("stan models","outs","fits","cush_pk_eca_ac.RDS"))
post_cush_pk_eca=cush_pk_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','b','sigma'),format='draws_matrix')
write.csv(post_cush_pk_eca,here('stan models','outs','posterior','cush_pk_eca_ac.csv'))

cush_pk_cpd = readRDS(here("stan models","outs","fits","cush_pk_cpd_ac.RDS"))
post_cush_pk_cpd=cush_pk_cpd$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','b','sigma'),format='draws_matrix')
write.csv(post_cush_pk_cpd,here('stan models','outs','posterior','cush_pk_cpd_ac.csv'))
