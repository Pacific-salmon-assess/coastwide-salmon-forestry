...
ch20r <- read.csv(here("origional-ecofish-data-models","Data","Processed","chum_SR_20_hat_yr_w_sstcobe_new.csv"))
...
ch20r$sst.std = (ch20r$spring_sst-mean(ch20r$spring_sst))/sd(ch20r$spring_sst)
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_chm_eca_npgo_sst <- mric$sample(data=dl_chm_eca_npgo_sst,
                            ...
                            adapt_delta = 0.999,
                            max_treedepth = 20)
  write.csv(ric_chm_eca_npgo_sst$summary(),'./stan models/outs/summary/ric_chm_eca_npgo_cobe_sst_trial.csv')
  ric_chm_eca_npgo_sst$save_object('./stan models/outs/fits/ric_chm_eca_npgo_cobe_sst_trial.RDS')
  ...
  write.csv(post_ric_chm_eca_npgo_sst,here('stan models','outs','posterior','ric_chm_eca_npgo_cobe_sst_trial.csv'))
  ...
  write.csv(ric_chm_eca_npgo_sst$summary(),here("stan models","outs","summary","ric_chm_eca_npgo_cobe_sst.csv"))
  ric_chm_eca_npgo_sst$save_object(here("stan models","outs","fits","ric_chm_eca_npgo_cobe_sst.RDS"))
  
  post_ric_chm_eca_npgo_sst=ric_chm_eca_npgo_sst$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                           'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'b_sst','b_sst_cu','b_sst_rv',
                                                           'alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_eca_npgo_sst,here('stan models','outs','posterior','ric_chm_eca_npgo_cobe_sst.csv'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_chm_cpd_npgo_sst <- mric$sample(data=dl_chm_cpd_npgo_sst,
                                  ...
                                  adapt_delta = 0.999,
                                  max_treedepth = 20)
  write.csv(ric_chm_cpd_npgo_sst$summary(),'./stan models/outs/summary/ric_chm_cpd_npgo_cobe_sst_trial.csv')
  ric_chm_cpd_npgo_sst$save_object('./stan models/outs/fits/ric_chm_cpd_npgo_cobe_sst_trial.RDS')
  
  post_ric_chm_cpd_npgo_sst=ric_chm_cpd_npgo_sst$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                           'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'b_sst','b_sst_cu','b_sst_rv',
                                                           'alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_cpd_npgo_sst,here('stan models','outs','posterior','ric_chm_cpd_npgo_cobe_sst_trial.csv'))
  ...
  write.csv(ric_chm_cpd_npgo_sst$summary(),here("stan models","outs","summary","ric_chm_cpd_npgo_cobe_sst.csv"))
  ric_chm_cpd_npgo_sst$save_object(here("stan models","outs","fits","ric_chm_cpd_npgo_cobe_sst.RDS"))
  
  post_ric_chm_cpd_npgo_sst=ric_chm_cpd_npgo_sst$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                           'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'b_sst','b_sst_cu','b_sst_rv',
                                                           'alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_cpd_npgo_sst,here('stan models','outs','posterior','ric_chm_cpd_npgo_cobe_sst.csv'))
