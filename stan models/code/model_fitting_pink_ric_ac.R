...
file_ric=file.path(here('stan models', 'code', 'ric_pink_ac_mk.stan'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_pk_eca <- mric_p$sample(data=dl_pk_eca,
                            ...
                            adapt_delta = 0.999,
                            max_treedepth = 20)
  write.csv(ric_pk_eca$summary(),'./stan models/outs/summary/ric_pk_eca_trial.csv')
  ric_pk_eca$save_object('./stan models/outs/fits/ric_pk_eca_trial.RDS')
  
  post_ric_pk_eca=ric_pk_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_pk_eca,here('stan models','outs','posterior','ric_pk_eca_trial.csv'))
  ...
  write.csv(ric_pk_eca$summary(),here("stan models","outs","summary","ric_pk_eca_ac.csv"))
  ric_pk_eca$save_object(here("stan models","outs","fits","ric_pk_eca_ac.RDS"))
  
  post_ric_pk_eca=ric_pk_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_pk_eca,here('stan models','outs','posterior','ric_pk_eca_ac.csv'))
