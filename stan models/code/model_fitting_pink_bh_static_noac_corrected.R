...
file_bh_st=file.path(here('stan models', 'code', 'bh_pink_static_noac_corrected.stan'))
mbh_p_st=cmdstanr::cmdstan_model(file_bh_st) #compile stan code to C++
...
if(Sys.info()[7] == "mariakur") {
  ...
  bh_pk_eca_st <- mbh_p_st$sample(data=dl_pk_eca,
                                      ...
                                      adapt_delta = 0.999,
                                      max_treedepth = 20)
  write.csv(bh_pk_eca_st$summary(),here("stan models","outs","summary","bh_pk_eca_st_noac_trial_corrected.csv"))
  bh_pk_eca_st$save_object(here("stan models","outs","fits","bh_pk_eca_st_noac_trial_corrected.RDS"))
  
  post_bh_pk_eca_st=bh_pk_eca_st$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_pk_eca_st,here('stan models','outs','posterior','bh_pk_eca_st_noac_trial_corrected.csv'))
  ...
  write.csv(bh_pk_eca_st$summary(),here("stan models","outs","summary","bh_pk_eca_st_noac_corrected.csv"))
  bh_pk_eca_st$save_object(here("stan models","outs","fits","bh_pk_eca_st_noac_corrected.RDS"))
  
  post_bh_pk_eca_st=bh_pk_eca_st$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_pk_eca_st,here('stan models','outs','posterior','bh_pk_eca_st_noac_corrected.csv'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  bh_pk_cpd_st <- mbh_p_st$sample(data=dl_pk_cpd,
                                      ...
                                      adapt_delta = 0.999,
                                      max_treedepth = 20)
  write.csv(bh_pk_cpd_st$summary(),here("stan models","outs","summary","bh_pk_cpd_st_noac_trial_corrected.csv"))
  bh_pk_cpd_st$save_object(here("stan models","outs","fits","bh_pk_cpd_st_noac_trial_corrected.RDS"))
  
  post_bh_pk_cpd_st=bh_pk_cpd_st$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_pk_cpd_st,here('stan models','outs','posterior','bh_pk_cpd_st_noac_trial_corrected.csv'))
  ...
  write.csv(bh_pk_cpd_st$summary(),here("stan models","outs","summary","bh_pk_cpd_st_noac_corrected.csv"))
  bh_pk_cpd_st$save_object(here("stan models","outs","fits","bh_pk_cpd_st_noac_corrected.RDS"))
  
  post_bh_pk_cpd_st=bh_pk_cpd_st$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_pk_cpd_st,here('stan models','outs','posterior','bh_pk_cpd_st_noac_corrected.csv'))
  
}

# traceplot(post_bh_pk_cpd_st, pars = c('b_for'))

# mcmc_trace(post_bh_pk_cpd_st, pars = c('b_for'))
