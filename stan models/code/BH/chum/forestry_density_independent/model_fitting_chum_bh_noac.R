...
file_bh=file.path(here('stan models', 'code','BH','chum','forestry_density_independent', 'bh_chm_noac.stan'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  bh_chm_eca <- mbh$sample(data=dl_chm_eca,
                              ...
                              adapt_delta = 0.999,
                              max_treedepth = 20)
  write.csv(bh_chm_eca$summary(),'./stan models/outs/summary/bh_chm_eca_noac_trial.csv')
  bh_chm_eca$save_object('./stan models/outs/fits/bh_chm_eca_noac_trial.RDS')
  
  post_bh_chm_eca=bh_chm_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_chm_eca,here('stan models','outs','posterior','bh_chm_eca_noac_trial.csv'))
  ...
  post_bh_chm_eca=bh_chm_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_chm_eca,here('stan models','outs','posterior','bh_chm_eca_noac.csv'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  write.csv(post_bh_chm_cpd,here('stan models','outs','posterior','bh_chm_cpd_noac_trial.csv'))
  ...
  post_bh_chm_cpd=bh_chm_cpd$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_t','alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_chm_cpd,here('stan models','outs','posterior','bh_chm_cpd_noac.csv'))
