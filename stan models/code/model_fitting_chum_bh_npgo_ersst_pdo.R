...
file_bh=file.path(here('stan models', 'code', 'bh_chm_static_npgo_sst_pdo.stan'))
...
ch20r$pdo.std = (ch20r$pdo-mean(ch20r$pdo))/sd(ch20r$pdo)
...
if(Sys.info()[7] == "mariakur") {
  ...
  bh_chm_eca_npgo <- mbh$sample(data=dl_chm_eca_npgo,
                              ...
                              adapt_delta = 0.999,
                              max_treedepth = 20)
  write.csv(bh_chm_eca_npgo$summary(),'./stan models/outs/summary/bh_chm_eca_npgo_ersst_pdo_trial.csv')
  bh_chm_eca_npgo$save_object('./stan models/outs/fits/bh_chm_eca_npgo_ersst_pdo_trial.RDS')

  post_bh_chm_eca_npgo=bh_chm_eca_npgo$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                         'b_npgo','b_npgo_cu','b_npgo_rv',
                                                         'b_sst','b_sst_cu','b_sst_rv', 'b_pdo', 'b_pdo_cu', 'b_pdo_rv',
                                                         'alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_chm_eca_npgo,here('stan models','outs','posterior','bh_chm_eca_npgo_ersst_pdo_trial.csv'))
  ...
  write.csv(bh_chm_eca_npgo$summary(),here("stan models","outs","summary","bh_chm_eca_npgo_ersst_pdo.csv"))
  bh_chm_eca_npgo$save_object(here("stan models","outs","fits","bh_chm_eca_npgo_ersst_pdo.RDS"))

  post_bh_chm_eca_npgo=bh_chm_eca_npgo$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                         'b_npgo','b_npgo_cu','b_npgo_rv',
                                                         'b_sst','b_sst_cu','b_sst_rv', 'b_pdo', 'b_pdo_cu', 'b_pdo_rv',
                                                         'alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_chm_eca_npgo,here('stan models','outs','posterior','bh_chm_eca_npgo_ersst_pdo.csv'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  bh_chm_cpd_npgo <- mbh$sample(data=dl_chm_cpd_npgo,
                              ...
                              adapt_delta = 0.999,
                              max_treedepth = 20)
  write.csv(bh_chm_cpd_npgo$summary(),'./stan models/outs/summary/bh_chm_cpd_npgo_ersst_pdo_trial.csv')
  bh_chm_cpd_npgo$save_object('./stan models/outs/fits/bh_chm_cpd_npgo_ersst_pdo_trial.RDS')
  
  post_bh_chm_cpd_npgo=bh_chm_cpd_npgo$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                         'b_npgo','b_npgo_cu','b_npgo_rv',
                                                         'b_sst','b_sst_cu','b_sst_rv', 'b_pdo', 'b_pdo_cu', 'b_pdo_rv',
                                                         'alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_chm_cpd_npgo,here('stan models','outs','posterior','bh_chm_cpd_npgo_ersst_pdo_trial.csv'))
  ...
  write.csv(bh_chm_cpd_npgo$summary(),here("stan models","outs","summary","bh_chm_cpd_npgo_ersst_pdo.csv"))
  bh_chm_cpd_npgo$save_object(here("stan models","outs","fits","bh_chm_cpd_npgo_ersst_pdo.RDS"))
  
  post_bh_chm_cpd_npgo=bh_chm_cpd_npgo$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                         'b_npgo','b_npgo_cu','b_npgo_rv',
                                                         'b_sst','b_sst_cu','b_sst_rv', 'b_pdo', 'b_pdo_cu', 'b_pdo_rv',
                                                         'alpha_j','Rk','sigma'),format='draws_matrix')
  write.csv(post_bh_chm_cpd_npgo,here('stan models','outs','posterior','bh_chm_cpd_npgo_ersst_pdo.csv'))
