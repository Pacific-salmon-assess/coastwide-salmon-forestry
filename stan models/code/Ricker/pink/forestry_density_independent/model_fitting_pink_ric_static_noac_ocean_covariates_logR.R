...
file_ric_st=file.path(here('stan models', 'code','Ricker','pink','forestry_density_independent',
                           'ric_pink_static_noac_ocean_covariates_logR.stan'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_pk_eca_st <- mric_p_st$sample(data=dl_pk_eca,
                                      ...
                                      adapt_delta = 0.95,
                                      max_treedepth = 20)
  write.csv(ric_pk_eca_st$summary(),here("stan models","outs","summary","ric_pk_eca_st_noac_ocean_covariates_logR_trial.csv"))
  ric_pk_eca_st$save_object(here("stan models","outs","fits","ric_pk_eca_st_noac_ocean_covariates_logR_trial.RDS"))
  ...
  write.csv(post_ric_pk_eca_st,here('stan models','outs','posterior','ric_pk_eca_st_noac_ocean_covariates_logR_trial.csv'))
  ...
  write.csv(ric_pk_eca_st$summary(),here("stan models","outs","summary","ric_pk_eca_st_noac_ocean_covariates_logR.csv"))
  ric_pk_eca_st$save_object(here("stan models","outs","fits","ric_pk_eca_st_noac_ocean_covariates_logR.RDS"))
  
  post_ric_pk_eca_st=ric_pk_eca_st$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                     'b_npgo','b_npgo_cu','b_npgo_rv',
                                                     'b_sst','b_sst_cu','b_sst_rv',
                                                     'alpha_j','Smax','sigma','sigma_for_cu','sigma_for_rv'),format='draws_matrix')
  write.csv(post_ric_pk_eca_st,here('stan models','outs','posterior','ric_pk_eca_st_noac_ocean_covariates_logR.csv'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_pk_cpd_st <- mric_p_st$sample(data=dl_pk_cpd,
                                      ...
                                      adapt_delta = 0.95,
                                      max_treedepth = 20)
  write.csv(ric_pk_cpd_st$summary(),here("stan models","outs","summary","ric_pk_cpd_st_noac_ocean_covariates_logR_trial.csv"))
  ric_pk_cpd_st$save_object(here("stan models","outs","fits","ric_pk_cpd_st_noac_ocean_covariates_logR_trial.RDS"))
  
  post_ric_pk_cpd_st=ric_pk_cpd_st$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                     'b_npgo','b_npgo_cu','b_npgo_rv',
                                                     'b_sst','b_sst_cu','b_sst_rv',
                                                     'alpha_j','Smax','sigma','sigma_for_cu','sigma_for_rv'),format='draws_matrix')
  write.csv(post_ric_pk_cpd_st,here('stan models','outs','posterior','ric_pk_cpd_st_noac_ocean_covariates_logR_trial.csv'))
  ...
  write.csv(ric_pk_cpd_st$summary(),here("stan models","outs","summary","ric_pk_cpd_st_noac_ocean_covariates_logR.csv"))
  ric_pk_cpd_st$save_object(here("stan models","outs","fits","ric_pk_cpd_st_noac_ocean_covariates_logR.RDS"))
  
  post_ric_pk_cpd_st=ric_pk_cpd_st$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                     'b_npgo','b_npgo_cu','b_npgo_rv',
                                                     'b_sst','b_sst_cu','b_sst_rv',
                                                     'alpha_j','Smax','sigma','sigma_for_cu','sigma_for_rv'),format='draws_matrix')
  write.csv(post_ric_pk_cpd_st,here('stan models','outs','posterior','ric_pk_cpd_st_noac_ocean_covariates_logR.csv'))
