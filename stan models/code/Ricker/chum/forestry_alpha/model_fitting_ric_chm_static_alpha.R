...
file_ric=file.path(here('stan models', 'code','Ricker','chum','forestry_alpha', 'ric_chm_static_alpha.stan'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_chm_eca <- mric$sample(data=dl_chm_eca,
                           ...
                           adapt_delta = 0.999,
                           max_treedepth = 20)
  write.csv(ric_chm_eca$summary(),'./stan models/outs/summary/ric_chm_eca_static_alpha_trial.csv')
  ric_chm_eca$save_object('./stan models/outs/fits/ric_chm_eca_static_alpha_trial.RDS')
  
  post_ric_chm_eca=ric_chm_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','K','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_eca,here('stan models','outs','posterior','ric_chm_eca_static_alpha_trial.csv'))
  ...
  write.csv(ric_chm_eca$summary(),here("stan models","outs","summary","ric_chm_eca_static_alpha.csv"))
  ric_chm_eca$save_object(here("stan models","outs","fits","ric_chm_eca_static_alpha.RDS"))
  
  post_ric_chm_eca=ric_chm_eca$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','K','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_eca,here('stan models','outs','posterior','ric_chm_eca_static_alpha.csv'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_chm_cpd <- mric$sample(data=dl_chm_cpd,
                           ...
                           adapt_delta = 0.999,
                           max_treedepth = 20)
  write.csv(ric_chm_cpd$summary(),'./stan models/outs/summary/ric_chm_cpd_static_alpha_trial.csv')
  ric_chm_cpd$save_object('./stan models/outs/fits/ric_chm_cpd_static_alpha_trial.RDS')
  
  post_ric_chm_cpd=ric_chm_cpd$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','K','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_cpd,here('stan models','outs','posterior','ric_chm_cpd_static_alpha_trial.csv'))
  ...
  write.csv(ric_chm_cpd$summary(),here("stan models","outs","summary","ric_chm_cpd_static_alpha.csv"))
  ric_chm_cpd$save_object(here("stan models","outs","fits","ric_chm_cpd_static_alpha.RDS"))
  
  post_ric_chm_cpd=ric_chm_cpd$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','K','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_cpd,here('stan models','outs','posterior','ric_chm_cpd_static_alpha.csv'))
