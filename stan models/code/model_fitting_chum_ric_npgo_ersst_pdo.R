...
file_ric=file.path(here('stan models', 'code', 'ric_chm_static_npgo_sst_pdo.stan'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_chm_eca_npgo_sst <- mric$sample(data=dl_chm_eca_npgo_sst,
                            ...
                            adapt_delta = 0.999,
                            max_treedepth = 20)
  write.csv(ric_chm_eca_npgo_sst$summary(),'./stan models/outs/summary/ric_chm_eca_npgo_ersst_pdo_trial.csv')
  ric_chm_eca_npgo_sst$save_object('./stan models/outs/fits/ric_chm_eca_npgo_ersst_pdo_trial.RDS')
  ...
  write.csv(post_ric_chm_eca_npgo_sst,here('stan models','outs','posterior','ric_chm_eca_npgo_ersst_pdo_trial.csv'))
  ...
  write.csv(ric_chm_eca_npgo_sst$summary(),here("stan models","outs","summary","ric_chm_eca_npgo_ersst_pdo.csv"))
  ric_chm_eca_npgo_sst$save_object(here("stan models","outs","fits","ric_chm_eca_npgo_ersst_pdo.RDS"))
  
  post_ric_chm_eca_npgo_sst=ric_chm_eca_npgo_sst$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                           'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'b_sst','b_sst_cu','b_sst_rv','b_pdo_cu', 'b_pdo_rv',
                                                           'alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_eca_npgo_sst,here('stan models','outs','posterior','ric_chm_eca_npgo_ersst_pdo.csv'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_chm_cpd_npgo_sst <- mric$sample(data=dl_chm_cpd_npgo_sst,
                                  ...
                                  adapt_delta = 0.999,
                                  max_treedepth = 20)
  write.csv(ric_chm_cpd_npgo_sst$summary(),'./stan models/outs/summary/ric_chm_cpd_npgo_ersst_pdo_trial.csv')
  ric_chm_cpd_npgo_sst$save_object('./stan models/outs/fits/ric_chm_cpd_npgo_ersst_pdo_trial.RDS')
  
  post_ric_chm_cpd_npgo_sst=ric_chm_cpd_npgo_sst$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                           'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'b_sst','b_sst_cu','b_sst_rv','b_pdo_cu', 'b_pdo_rv',
                                                           'alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_cpd_npgo_sst,here('stan models','outs','posterior','ric_chm_cpd_npgo_ersst_pdo_trial.csv'))
  ...
  write.csv(ric_chm_cpd_npgo_sst$summary(),here("stan models","outs","summary","ric_chm_cpd_npgo_ersst_pdo.csv"))
  ric_chm_cpd_npgo_sst$save_object(here("stan models","outs","fits","ric_chm_cpd_npgo_ersst_pdo.RDS"))
  
  post_ric_chm_cpd_npgo_sst=ric_chm_cpd_npgo_sst$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                                           'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'b_sst','b_sst_cu','b_sst_rv','b_pdo_cu', 'b_pdo_rv',
                                                           'alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_cpd_npgo_sst,here('stan models','outs','posterior','ric_chm_cpd_npgo_ersst_pdo.csv'))
