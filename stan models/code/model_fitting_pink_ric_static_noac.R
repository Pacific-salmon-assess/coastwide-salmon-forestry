...
file_ric_st=file.path(here('stan models', 'code', 'ric_pink_static_noac.stan'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_pk_eca_st <- mric_p_st$sample(data=dl_pk_eca,
                                      ...
                                      adapt_delta = 0.999,
                                      max_treedepth = 20)
  write.csv(ric_pk_eca_st$summary(),here("stan models","outs","summary","ric_pk_eca_st_noac_trial.csv"))
  ric_pk_eca_st$save_object(here("stan models","outs","fits","ric_pk_eca_st_noac_trial.RDS"))
  
  post_ric_pk_eca_st=ric_pk_eca_st$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_pk_eca_st,here('stan models','outs','posterior','ric_pk_eca_st_noac_trial.csv'))
  ...
  ric_pk_eca_st$save_object(here("stan models","outs","fits","ric_pk_eca_st_noac.RDS"))
  
  post_ric_pk_eca_st=ric_pk_eca_st$draws(variables=c('b_for','b_for_cu','b_for_rv','alpha_j','Smax','sigma'),format='draws_matrix')
  write.csv(post_ric_pk_eca_st,here('stan models','outs','posterior','ric_pk_eca_st_noac.csv'))
