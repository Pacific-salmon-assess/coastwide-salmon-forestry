...
if(Sys.info()[7] == "mariakur") {
  bh_pk_eca <- load(here('stan models','outs','fits','bh_pk_eca_noac_w_npgo_trial.RDS'))
  ...
  bh_pk_cpd <- load(here('stan models','outs','fits','bh_pk_cpd_noac_w_npgo_trial.RDS'))
  ...
  bh_pk_eca <- load(here('stan models','outs','fits','bh_pk_eca_noac_w_npgo.RDS'))
  post_bh_pk_eca=bh_pk_eca$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                             'b_npgo','b_npgo_cu','b_npgo_rv',
                                             'alpha_j','Rk','sigma_for_cu','sigma_for_rv'),format='draws_matrix')
  ...
  bh_pk_cpd <- load(here('stan models','outs','fits','bh_pk_cpd_noac_w_npgo.RDS'))
  post_bh_pk_cpd=bh_pk_cpd$draws(variables=c('b_for','b_for_cu','b_for_rv',
                                             'b_npgo','b_npgo_cu','b_npgo_rv',
                                             'alpha_j','Rk','sigma_for_cu','sigma_for_rv'),format='draws_matrix')
