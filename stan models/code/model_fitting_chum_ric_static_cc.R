...
file_ric=file.path(here('stan models', 'code', 'ric_chm_static_cc.stan'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_chm_eca_static <- mric$sample(data=dl_chm_eca_static,
                            ...
                            adapt_delta = 0.99,
                            max_treedepth = 20)
  write.csv(ric_chm_eca_static$summary(),'./stan models/outs/summary/ric_chm_eca_static_trial_cc.csv')
  ric_chm_eca_static$save_object('./stan models/outs/fits/ric_chm_eca_static_trial_cc.RDS')
  
  post_ric_chm_eca_static=ric_chm_eca_static$draws(variables=c('b_for','b_for_cu','b_for_rv','k',
                                                           # 'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'alpha_j','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_eca_static,here('stan models','outs','posterior','ric_chm_eca_static_trial_cc.csv'))
  ...
  ric_chm_eca_static$save_object(here("stan models","outs","fits","ric_chm_eca_static_cc.RDS"))
  
  post_ric_chm_eca_static=ric_chm_eca_static$draws(variables=c('b_for','b_for_cu','b_for_rv','k',
                                                           # 'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'alpha_j','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_eca_static,here('stan models','outs','posterior','ric_chm_eca_static_cc.csv'))
...
if(Sys.info()[7] == "mariakur") {
  ...
  ric_chm_cpd_static <- mric$sample(data=dl_chm_cpd_static,
                                  ...
                                  adapt_delta = 0.99,
                                  max_treedepth = 20)
  write.csv(ric_chm_cpd_static$summary(),'./stan models/outs/summary/ric_chm_cpd_static_trial_cc.csv')
  ric_chm_cpd_static$save_object('./stan models/outs/fits/ric_chm_cpd_static_trial_cc.RDS')
  
  post_ric_chm_cpd_static=ric_chm_cpd_static$draws(variables=c('b_for','b_for_cu','b_for_rv','k',
                                                           # 'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'alpha_j','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_cpd_static,here('stan models','outs','posterior','ric_chm_cpd_static_trial_cc.csv'))
  ...
  ric_chm_cpd_static$save_object(here("stan models","outs","fits","ric_chm_cpd_static_cc.RDS"))
  
  post_ric_chm_cpd_static=ric_chm_cpd_static$draws(variables=c('b_for','b_for_cu','b_for_rv','k',
                                                           # 'b_npgo','b_npgo_cu','b_npgo_rv',
                                                           'alpha_j','sigma'),format='draws_matrix')
  write.csv(post_ric_chm_cpd_static,here('stan models','outs','posterior','ric_chm_cpd_static_cc.csv'))
